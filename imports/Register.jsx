      ...
      <form onSubmit={props.tryRegister} autoComplete="off">
        ...
        <div className="form-input-wrapper">
          ...
          <input
            ...
            value={props.registerStateData.registerEmail}
            placeholder="Email"
            onFocus={highlight}
          />
        </div>
        ...
        <div className="form-input-wrapper">
          ...
          <input
            ...
            onChange={changeRegisterState}
            value={props.registerStateData.registerPassword}
        ...
        <br />
        <div style={{ textAlign: "center", color: "#FFF", margin: 0 }}>
          {" "}
          ...
          <span
            onClick={() => {
              swal(
                "Bed Time?",
                "This will help Tadu optimize your schedule when you're most awake and productive."
              );
            }}
            style={{ color: "#33FFCC" }}
          >
        ...
        <div className="form-input-wrapper">
          ...
          <input
            ...
            id="register-bedHour"
            onChange={changeRegisterState}
            value={props.registerStateData.registerBedHour}
        ...
        <div className="privacy-policy">
          ...
          <span onClick={showPolicy} style={{ textDecoration: "underline" }}>
            {" "}
            Privacy Policy{" "}
          </span>
        ...
        <p className="toggle-login pulse">
          Already registered?{" "}
          <span onClick={props.handleChangeForm}>Log in</span>
        </p>
      </form>
    </div>
  );
