https://www.npmjs.com/package/react-tiny-virtual-list
...
const get20Years = ()=>{
	var allYears = [];
	for(let i = 12; i > 0; i--){
		allYears.push(moment().subtract(i, "months").format("YYYY-MM-01"));
}
	allYears.push(moment().format("YYYY-MM-01")); 

	for(var i = 0; i < 12; i++){ 
		allYears.push(moment().add(i, "months").format("YYYY-MM-01")) 
	} 
	return allYears 
};
